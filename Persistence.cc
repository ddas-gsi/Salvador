...
const int NTRIG = 20; // number of trigger bits
...
int main(int argc, char *argv[])
{
  ...
  // histograms
  TH1F *trigger = new TH1F("trigger", "trigger", NTRIG, 0, NTRIG);
  hlist->Add(trigger);
  TH1F *fpCutMask_br = new TH1F("fpCutMask_br", "fpCutMask_br", 16, 0, 16);
  hlist->Add(fpCutMask_br);
  TH1F *fpCutMask_zd = new TH1F("fpCutMask_zd", "fpCutMask_zd", 16, 0, 16);
  hlist->Add(fpCutMask_zd);
  TH2F *bigrips = new TH2F("bigrips", "bigrips", 1000, 2.2, 2.8, 1000, 0, 40);
  hlist->Add(bigrips);
  TH2F *zerodeg = new TH2F("zerodeg", "zerodeg", 1000, 2.2, 2.8, 1000, 0, 40);
  hlist->Add(zerodeg);
  TH2F *bigrips_corr = new TH2F("bigrips_corr", "bigrips_corr", 1000, 2.2, 2.8, 1000, 0, 40);
  ...
  {
    bigrips_tr[i] = new TH2F(Form("bigrips_tr%d", i), Form("bigrips_tr%d", i), 1000, 2.2, 2.8, 1000, 0, 40);
    hlist->Add(bigrips_tr[i]);
    zerodeg_tr[i] = new TH2F(Form("zerodeg_tr%d", i), Form("zerodeg_tr%d", i), 1000, 2.2, 2.8, 1000, 0, 40);
    hlist->Add(zerodeg_tr[i]);
    f5X_tr[i] = new TH1F(Form("f5X_tr%d", i), Form("f5X_tr%d", i), 3000, -150, 150);
    hlist->Add(f5X_tr[i]);
  }
  ...
  for (int p = 0; p < 6; p++)
  {
    f8ppacX[p] = new TH1F(Form("f8ppacX_%d", p), Form("f8ppacX_%d", p), 200, -100, 100);
    hlist->Add(f8ppacX[p]);
    f8ppacY[p] = new TH1F(Form("f8ppacY_%d", p), Form("f8ppacY_%d", p), 200, -100, 100);
    hlist->Add(f8ppacY[p]);
    f8ppacXY[p] = new TH2F(Form("f8ppacXY_%d", p), Form("f8ppacXY_%d", p), 200, -100, 100, 200, -100, 100);
    hlist->Add(f8ppacXY[p]);
  }
  TH2F *compareX[2];
  TH2F *compareY[2];
  TH1F *compare1dX[2];
  ...
  for (int p = 0; p < 2; p++)
  {
    compareX[p] = new TH2F(Form("compareX_%d", p), Form("compareX_%d", p), 200, -100, 100, 200, -100, 100);
    hlist->Add(compareX[p]);
    compareY[p] = new TH2F(Form("compareY_%d", p), Form("compareY_%d", p), 200, -100, 100, 200, -100, 100);
    hlist->Add(compareY[p]);
    compare1dX[p] = new TH1F(Form("compare1dX_%d", p), Form("compare1dX_%d", p), 1000, -100, 100);
    hlist->Add(compare1dX[p]);
    compare1dY[p] = new TH1F(Form("compare1dY_%d", p), Form("compare1dY_%d", p), 1000, -100, 100);
    hlist->Add(compare1dY[p]);
  }
  TH2F *compareA = new TH2F("compareA", "compareA", 200, -100, 100, 200, -100, 100);
  hlist->Add(compareA);
  TH2F *compareB = new TH2F("compareB", "compareB", 200, -100, 100, 200, -100, 100);
  hlist->Add(compareB);
  TH2F *ppacZpos = new TH2F("ppacZpos", "ppacZpos", 40, 0, 40, 3000, -1500, 1500);
  hlist->Add(ppacZpos);
  TH2F *incAB = new TH2F("incAB", "incAB", 300, -30, 30, 300, -30, 30);
  hlist->Add(incAB);
  TH2F *scaAB = new TH2F("scaAB", "scaAB", 300, -30, 30, 300, -30, 30);
  hlist->Add(scaAB);
  TH2F *targetXY = new TH2F("targetXY", "targetXY", 200, -100, 100, 200, -100, 100);
  hlist->Add(targetXY);
  TH2F *thetaphi = new TH2F("thetaphi", "thetaphi", 800, -4, 4, 1500, 0, 150);
  hlist->Add(thetaphi);
  TH2F *thetaphideg = new TH2F("thetaphideg", "thetaphideg", 800, -180, 180, 1500, 0, 5);
  hlist->Add(thetaphideg);
  TH2F *thetaphiin = new TH2F("thetaphiin", "thetaphiin", 800, -4, 4, 1500, 0, 150);
  hlist->Add(thetaphiin);
  TH2F *thetaphiout = new TH2F("thetaphiout", "thetaphiout", 800, -4, 4, 1500, 0, 150);
  hlist->Add(thetaphiout);
  TH2F *thetaphisca = new TH2F("thetaphisca", "thetaphisca", 800, -4, 4, 1500, 0, 150);
  hlist->Add(thetaphisca);
  TH2F *phiinout = new TH2F("phiinout", "phiinout", 800, -4, 4, 800, -4, 4);
  hlist->Add(phiinout);
  TH2F *thetaphi_tr[10];
  TH2F *thetaphideg_tr[10];
  for (int i = 0; i < 10; i++)
  {
    thetaphi_tr[i] = new TH2F(Form("thetaphi_tr%d", i), Form("thetaphi_tr%d", i), 800, -4, 4, 1500, 0, 150);
    hlist->Add(thetaphi_tr[i]);
    thetaphideg_tr[i] = new TH2F(Form("thetaphideg_tr%d", i), Form("thetaphideg_tr%d", i), 800, -180, 180, 1500, 0, 5);
    hlist->Add(thetaphideg_tr[i]);
  }
  TH1F *bbeta[3];
  for (unsigned short b = 0; b < 3; b++)
  {
    bbeta[b] = new TH1F(Form("bbeta_%d", b), Form("bbeta_%d", b), 10000, 0, 1);
    hlist->Add(bbeta[b]);
  }
  // RIPSBeta
  TH1F *ripsbeta[6];
  ...
  hlist->Add(PL3PPAC3);
  TH2F *PL7PPAC7 = new TH2F("PL7PPAC7", "PL7PPAC7", 1000, -5, 5, 1000, -150, 150);
  hlist->Add(PL7PPAC7);
  TH2F *PL9PPAC9 = new TH2F("PL9PPAC9", "PL9PPAC9", 1000, -5, 5, 1000, -150, 150);
  hlist->Add(PL9PPAC9);
  TH2F *PL11PPAC11 = new TH2F("PL11PPAC11", "PL11PPAC11", 1000, -5, 5, 1000, -150, 150);
  hlist->Add(PL11PPAC11);
  TH2F *PL3PL3 = new TH2F("PL3PL3", "PL3PL3", 1000, -5, 5, 1000, -5, 5);
  hlist->Add(PL3PL3);
  TH2F *PL7PL7 = new TH2F("PL7PL7", "PL7PL7", 1000, -5, 5, 1000, -5, 5);
  hlist->Add(PL7PL7);
  TH2F *PL9PL9 = new TH2F("PL9PL9", "PL9PL9", 1000, -5, 5, 1000, -5, 5);
  hlist->Add(PL9PL9);
  TH2F *PL11PL11 = new TH2F("PL11PL11", "PL11PL11", 1000, -5, 5, 1000, -5, 5);
  hlist->Add(PL11PL11);

  TH1F *tdiff = new TH1F("tdiff", "tdiff", 2000, -1000, 1000);
  hlist->Add(tdiff);
  TH1F *rdiff = new TH1F("rdiff", "rdiff", 2000, 0, 200);
  hlist->Add(rdiff);
  TH1F *adiff = new TH1F("adiff", "adiff", 2000, 0, 4);
  hlist->Add(adiff);
  TH2F *radiff = new TH2F("radiff", "radiff", 200, 0, 4, 2000, 0, 200);
  hlist->Add(radiff);
  ...
  hlist->Add(egamdcmult);
  TH2F *egammult_IDgate = new TH2F("egammult_IDgate", "egammult_IDgate", 20, 0, 20, bins, 0, bins);
  hlist->Add(egammult_IDgate);
  TH2F *egamdcmult_IDgate = new TH2F("egamdcmult_IDgate", "egamdcmult_IDgate", 20, 0, 20, bins, 0, bins);
  hlist->Add(egamdcmult_IDgate);
  TH2F *egamtrig = new TH2F("egamtrig", "egamtrig", NTRIG, 0, NTRIG, bins, 0, bins);
  hlist->Add(egamtrig);
  TH2F *egamID_mult[10];
  TH2F *egamdcID_mult[10];
  TH2F *egamdctrig_mult[10];
  TH2F *egamdctrigmult_theta[NTRIG][10];
  ...
  TH2F *egamABmult = new TH2F("egamABmult", "egamABmult", 20, 0, 20, bins, 0, bins);
  hlist->Add(egamABmult);
  TH2F *egamABmultAB = new TH2F("egamABmultAB", "egamABmultAB", 20, 0, 20, bins, 0, bins);
  hlist->Add(egamABmultAB);
  TH2F *egamABdcmult = new TH2F("egamABdcmult", "egamABdcmult", 20, 0, 20, bins, 0, bins);
  ...
  hlist->Add(egamABdc_IDgate);
  TH2F *egamABmult_IDgate = new TH2F("egamABmult_IDgate", "egamABmult_IDgate", 20, 0, 20, bins, 0, bins);
  hlist->Add(egamABmult_IDgate);
  TH2F *egamABmultAB_IDgate = new TH2F("egamABmultAB_IDgate", "egamABmultAB_IDgate", 20, 0, 20, bins, 0, bins);
  hlist->Add(egamABmultAB_IDgate);
  TH2F *egamABdcmult_IDgate = new TH2F("egamABdcmult_IDgate", "egamABdcmult_IDgate", 20, 0, 20, bins, 0, bins);
  hlist->Add(egamABdcmult_IDgate);
  TH2F *egamABdcmultAB_IDgate = new TH2F("egamABdcmultAB_IDgate", "egamABdcmultAB_IDgate", 20, 0, 20, bins, 0, bins);
  hlist->Add(egamABdcmultAB_IDgate);
  TH2F *egamABtrig = new TH2F("egamABtrig", "egamABtrig", NTRIG, 0, NTRIG, bins, 0, bins);
  hlist->Add(egamABtrig);
  ...
  TH2F *egamABdctrigmult_theta[NTRIG][10];
  TH2F *egamABdctrigmultAB_theta[NTRIG][10];
  ...
  egamID_mult[0] = new TH2F("egamID", "egamID", DALIIDS, 0, DALIIDS, bins, 0, bins);
  hlist->Add(egamID_mult[0]);
  egamdcID_mult[0] = new TH2F("egamdcID", "egamdcID", DALIIDS, 0, DALIIDS, bins, 0, bins);
  hlist->Add(egamdcID_mult[0]);
  egamdctrig_mult[0] = new TH2F("egamdctrig", "egamdctrig", NTRIG, 0, NTRIG, bins, 0, bins);
  ...
  egamABID_mult[0] = new TH2F("egamABID", "egamABID", DALIIDS, 0, DALIIDS, bins, 0, bins);
  hlist->Add(egamABID_mult[0]);
  egamABdcID_mult[0] = new TH2F("egamABdcID", "egamABdcID", DALIIDS, 0, DALIIDS, bins, 0, bins);
  hlist->Add(egamABdcID_mult[0]);
  egamABdctrig_mult[0] = new TH2F("egamABdctrig", "egamABdctrig", NTRIG, 0, NTRIG, bins, 0, bins);
  hlist->Add(egamABdctrig_mult[0]);
  for (int t = 0; t < NTRIG; t++)
  {
    egamdctrigmult_theta[t][0] = new TH2F(Form("egamdctrig%d_theta", t), Form("egamdctrig%d_theta", t), 100, 0, 5, bins, 0, bins);
    hlist->Add(egamdctrigmult_theta[t][0]);
    egamABdctrigmult_theta[t][0] = new TH2F(Form("egamABdctrig%d_theta", t), Form("egamABdctrig%d_theta", t), 100, 0, 5, bins, 0, bins);
    hlist->Add(egamABdctrigmult_theta[t][0]);
  }

  egamegam_mult[0] = new TH2F("egamegam", "egamegam", 200, 0, 4000, 200, 0, 4000);
  hlist->Add(egamegam_mult[0]);
  egamegamdc_mult[0] = new TH2F("egamegamdc", "egamegamdc", 200, 0, 4000, 200, 0, 4000);
  hlist->Add(egamegamdc_mult[0]);
  egamegamAB_mult[0] = new TH2F("egamegamAB", "egamegamAB", 200, 0, 4000, 200, 0, 4000);
  hlist->Add(egamegamAB_mult[0]);
  egamegamABdc_mult[0] = new TH2F("egamegamABdc", "egamegamABdc", 200, 0, 4000, 200, 0, 4000);
  hlist->Add(egamegamABdc_mult[0]);
  egamegam_IDgate_mult[0] = new TH2F("egamegam_IDgate", "egamegam_IDgate", 200, 0, 4000, 200, 0, 4000);
  hlist->Add(egamegam_IDgate_mult[0]);
  egamegamdc_IDgate_mult[0] = new TH2F("egamegamdc_IDgate", "egamegamdc_IDgate", 200, 0, 4000, 200, 0, 4000);
  hlist->Add(egamegamdc_IDgate_mult[0]);
  egamegamAB_IDgate_mult[0] = new TH2F("egamegamAB_IDgate", "egamegamAB_IDgate", 200, 0, 4000, 200, 0, 4000);
  hlist->Add(egamegamAB_IDgate_mult[0]);
  egamegamABdc_IDgate_mult[0] = new TH2F("egamegamABdc_IDgate", "egamegamABdc_IDgate", 200, 0, 4000, 200, 0, 4000);
  hlist->Add(egamegamABdc_IDgate_mult[0]);
  for (int m = 1; m < 10; m++)
  {
    egamID_mult[m] = new TH2F(Form("egamIDmult%d", m), Form("egamIDmult%d", m), DALIIDS, 0, DALIIDS, 400, 0, 4000);
    hlist->Add(egamID_mult[m]);
    egamdcID_mult[m] = new TH2F(Form("egamdcIDmult%d", m), Form("egamdcIDmult%d", m), DALIIDS, 0, DALIIDS, 400, 0, 4000);
    hlist->Add(egamdcID_mult[m]);
    egamdctrig_mult[m] = new TH2F(Form("egamdctrigmult%d", m), Form("egamdctrigmult%d", m), NTRIG, 0, NTRIG, 400, 0, 4000);
    hlist->Add(egamdctrig_mult[m]);
    egamdctheta_mult[m] = new TH2F(Form("egamdcthetamult%d", m), Form("egamdcthetamult%d", m), 200, 0, 4, 400, 0, 4000);
    hlist->Add(egamdctheta_mult[m]);
    egamdcphi_mult[m] = new TH2F(Form("egamdcphimult%d", m), Form("egamdcphimult%d", m), 200, -4, 4, 400, 0, 4000);
    hlist->Add(egamdcphi_mult[m]);
    egamABID_mult[m] = new TH2F(Form("egamABIDmult%d", m), Form("egamABIDmult%d", m), DALIIDS, 0, DALIIDS, 400, 0, 4000);
    hlist->Add(egamABID_mult[m]);
    egamABID_multAB[m] = new TH2F(Form("egamABIDmultAB%d", m), Form("egamABIDmultAB%d", m), DALIIDS, 0, DALIIDS, 400, 0, 4000);
    hlist->Add(egamABID_multAB[m]);
    egamABdcID_mult[m] = new TH2F(Form("egamABdcIDmult%d", m), Form("egamABdcIDmult%d", m), DALIIDS, 0, DALIIDS, 400, 0, 4000);
    hlist->Add(egamABdcID_mult[m]);
    egamABdcID_multAB[m] = new TH2F(Form("egamABdcIDmultAB%d", m), Form("egamABdcIDmultAB%d", m), DALIIDS, 0, DALIIDS, 400, 0, 4000);
    hlist->Add(egamABdcID_multAB[m]);
    egamABdctrig_mult[m] = new TH2F(Form("egamABdctrigmult%d", m), Form("egamABdctrigmult%d", m), NTRIG, 0, NTRIG, 400, 0, 4000);
    hlist->Add(egamABdctrig_mult[m]);
    egamABdctrig_multAB[m] = new TH2F(Form("egamABdctrigmultAB%d", m), Form("egamABdctrigmultAB%d", m), NTRIG, 0, NTRIG, 400, 0, 4000);
    hlist->Add(egamABdctrig_multAB[m]);
    for (int t = 0; t < NTRIG; t++)
    {
      egamdctrigmult_theta[t][m] = new TH2F(Form("egamdctrig%dmult%d_theta", t, m), Form("egamdctrig%dmult%d_theta", t, m), 100, 0, 5, 4000, 0, 4000);
      hlist->Add(egamdctrigmult_theta[t][m]);
      egamABdctrigmult_theta[t][m] = new TH2F(Form("egamABdctrig%dmult%d_theta", t, m), Form("egamABdctrig%dmult%d_theta", t, m), 100, 0, 5, 4000, 0, 4000);
      hlist->Add(egamABdctrigmult_theta[t][m]);
      egamABdctrigmultAB_theta[t][m] = new TH2F(Form("egamABdctrig%dmultAB%d_theta", t, m), Form("egamABdctrig%dmultAB%d_theta", t, m), 100, 0, 5, 4000, 0, 4000);
      hlist->Add(egamABdctrigmultAB_theta[t][m]);
    }

    egamegam_mult[m] = new TH2F(Form("egamegammult%d", m), Form("egamegammult%d", m), 200, 0, 4000, 200, 0, 4000);
    hlist->Add(egamegam_mult[m]);
    egamegamdc_mult[m] = new TH2F(Form("egamegamdcmult%d", m), Form("egamegamdcmult%d", m), 200, 0, 4000, 200, 0, 4000);
    hlist->Add(egamegamdc_mult[m]);
    egamegamAB_mult[m] = new TH2F(Form("egamegamABmult%d", m), Form("egamegamABmult%d", m), 200, 0, 4000, 200, 0, 4000);
    hlist->Add(egamegamAB_mult[m]);
    egamegamABdc_mult[m] = new TH2F(Form("egamegamABdcmult%d", m), Form("egamegamABdcmult%d", m), 200, 0, 4000, 200, 0, 4000);
    hlist->Add(egamegamABdc_mult[m]);
    egamegamAB_multAB[m] = new TH2F(Form("egamegamABmultAB%d", m), Form("egamegamABmultAB%d", m), 200, 0, 4000, 200, 0, 4000);
    hlist->Add(egamegamAB_multAB[m]);
    egamegamABdc_multAB[m] = new TH2F(Form("egamegamABdcmultAB%d", m), Form("egamegamABdcmultAB%d", m), 200, 0, 4000, 200, 0, 4000);
    hlist->Add(egamegamABdc_multAB[m]);

    egamegam_IDgate_mult[m] = new TH2F(Form("egamegammult%d_IDgate", m), Form("egamegammult%d_IDgate", m), 200, 0, 4000, 200, 0, 4000);
    hlist->Add(egamegam_IDgate_mult[m]);
    egamegamdc_IDgate_mult[m] = new TH2F(Form("egamegamdcmult%d_IDgate", m), Form("egamegamdcmult%d_IDgate", m), 200, 0, 4000, 200, 0, 4000);
    hlist->Add(egamegamdc_IDgate_mult[m]);
    egamegamAB_IDgate_mult[m] = new TH2F(Form("egamegamABmult%d_IDgate", m), Form("egamegamABmult%d_IDgate", m), 200, 0, 4000, 200, 0, 4000);
    hlist->Add(egamegamAB_IDgate_mult[m]);
    egamegamABdc_IDgate_mult[m] = new TH2F(Form("egamegamABdcmult%d_IDgate", m), Form("egamegamABdcmult%d_IDgate", m), 200, 0, 4000, 200, 0, 4000);
    hlist->Add(egamegamABdc_IDgate_mult[m]);
    egamegamAB_IDgate_multAB[m] = new TH2F(Form("egamegamABmultAB%d_IDgate", m), Form("egamegamABmultAB%d_IDgate", m), 200, 0, 4000, 200, 0, 4000);
    hlist->Add(egamegamAB_IDgate_multAB[m]);
    egamegamABdc_IDgate_multAB[m] = new TH2F(Form("egamegamABdcmultAB%d_IDgate", m), Form("egamegamABdcmultAB%d_IDgate", m), 200, 0, 4000, 200, 0, 4000);
    hlist->Add(egamegamABdc_IDgate_multAB[m]);
  }

  // const int NTRIG = 100; // number of trigger bits

  TH2F *egamdcmult_trig[NTRIG];
  TH2F *egamABdcmult_trig[NTRIG];
  TH2F *egamABdcmultAB_trig[NTRIG];
  TH2F *egamdcmult_IDgate_trig[NTRIG];
  TH2F *egamABdcmult_IDgate_trig[NTRIG];
  TH2F *egamABdcmultAB_IDgate_trig[NTRIG];
  for (int i = 0; i < NTRIG; i++)
  {
    egamdcmult_trig[i] = new TH2F(Form("egamdcmult_trig%d", i), Form("egamdcmult_trig%d", i), 20, 0, 20, bins, 0, bins);
    hlist->Add(egamdcmult_trig[i]);
    egamABdcmult_trig[i] = new TH2F(Form("egamABdcmult_trig%d", i), Form("egamABdcmult_trig%d", i), 20, 0, 20, bins, 0, bins);
    hlist->Add(egamABdcmult_trig[i]);
    egamABdcmultAB_trig[i] = new TH2F(Form("egamABdcmultAB_trig%d", i), Form("egamABdcmultAB_trig%d", i), 20, 0, 20, bins, 0, bins);
    hlist->Add(egamABdcmultAB_trig[i]);
    egamdcmult_IDgate_trig[i] = new TH2F(Form("egamdcmult_IDgate_trig%d", i), Form("egamdcmult_IDgate_trig%d", i), 20, 0, 20, bins, 0, bins);
    hlist->Add(egamdcmult_IDgate_trig[i]);
    egamABdcmult_IDgate_trig[i] = new TH2F(Form("egamABdcmult_IDgate_trig%d", i), Form("egamABdcmult_IDgate_trig%d", i), 20, 0, 20, bins, 0, bins);
    hlist->Add(egamABdcmult_IDgate_trig[i]);
    egamABdcmultAB_IDgate_trig[i] = new TH2F(Form("egamABdcmultAB_IDgate_trig%d", i), Form("egamABdcmultAB_IDgate_trig%d", i), 20, 0, 20, bins, 0, bins);
    hlist->Add(egamABdcmultAB_IDgate_trig[i]);
  }
